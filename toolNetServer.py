...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.fc1=nn.Linear(32*88*88,128) #输入的高度是64，长宽为42，因为经过3次池化
        self.fc2 = nn.Linear(128, 64)
        self.fc3 = nn.Linear(64, 5) #输出5个值
...
if __name__ == '__main__':
    ...
    while True:
        ...
        while True:
            ...
            send_data = str(result[0])+":"+str(result[1][0])+"|"+str(result[1][1])+"|"+str(result[1][2])+"|"+str(result[1][3])+"|"+str(result[1][4])
