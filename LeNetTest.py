...
test_loader = Data.DataLoader(test_data,batch_size=50,shuffle=True, num_workers=2)
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.fc1=nn.Linear(32*56*56,120) #输入的高度是32，长宽为56，因为经过两次池化
        self.fc2 = nn.Linear(120, 84)
        self.fc3 = nn.Linear(84, 6) #输出6个值
